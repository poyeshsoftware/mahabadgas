...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    acceptDelete: function () {
      var _acceptDelete = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.$store.dispatch("dataList/removeFactor", tr.id).catch(function (err) {
                  console.error(err);
                  return 0;
                });
              ...
              case 2:
                this.$vs.notify({
                  ...
                  text: this.$t('Factor_Has_Been_Removed_Msg', [tr.name])
                });
      ...
      function acceptDelete(_x) {
        return _acceptDelete.apply(this, arguments);
      }
    ...
    [
      ...
      _c(
        "vs-table",
        {
          ...
          on: { search: _vm.handleSearch, "change-page": _vm.handleChangePage },
          scopedSlots: _vm._u([
            {
              key: "default",
              fn: function(ref) {
          ...
          _c(
            ...
            [
              _c("vs-th", { attrs: { "sort-key": "name" } }, [
                _vm._v(_vm._s(_vm.$t("Driver_Name")))
              ]),
              _vm._v(" "),
