...
/* harmony import */ var _components_DriverSidebar_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/DriverSidebar.vue */ "./resources/js/src/views/pages/components/DriverSidebar.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    DriverSidebar: _components_DriverSidebar_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      selected: [],
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.$store.dispatch("dataList/removeDriver", tr.id)["catch"](function (err) {
                  console.error(err);
                  return 0;
                });
              ...
              case 2:
                _this.$vs.notify({
                  ...
                  text: _this.$t('Driver_Has_Been_Removed_Msg', [tr.name])
                });
      ...
      this.$validator.validateAll().then(function (result) {
        if (result) {
          ...
          if (_this.dataId !== null && _this.dataId >= 0) {
            _this.$store.dispatch("dataList/updateDriver", obj)["catch"](function (err) {
              console.error(err);
            });
          } else {
            delete obj.id;

            _this.$store.dispatch("dataList/addDriver", obj)["catch"](function (err) {
              console.error(err);
            });
          }
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        [_vm._v(_vm._s(_vm.$t("Add_New_Driver")))]
                      )
                    ],
                    1
                  )
          ...
          _c(
            ...
            [
              _c("vs-input", {
                ...
                attrs: { label: _vm.$t("Name"), name: "driver_name" },
                model: {
                  value: _vm.dataName,
                  callback: function($$v) {
                    _vm.dataName = $$v
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: _vm.errors.has("driver_name"),
                      expression: "errors.has('driver_name')"
                    }
                  ],
                  staticClass: "text-danger text-sm"
                },
                [_vm._v(_vm._s(_vm.errors.first("driver_name")))]
              )
            ],
            1
          )
