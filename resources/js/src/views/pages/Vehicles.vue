<template>
    <div id="data-list-list-view" class="data-list-container">
        ...
        <vehicle-sidebar :isSidebarActive="addNewDataSidebar" @closeSidebar="toggleDataSidebar" :data="sidebarData"/>

        <vs-table ref="table" pagination :max-items="itemsPerPage" search :noDataText="this.$t('No_Data_Text')"
                  :data="this.vehicles">
            ...
            <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
                ...
                <div class="flex flex-wrap-reverse items-center data-list-btn-container">
                    ...
                    <div
                        ...
                        <span class="ml-2 text-base text-primary">{{ $t('Add_Vehicle') }}</span>
                    </div>
                </div>
                ...
                <vs-dropdown vs-trigger-click class="cursor-pointer mb-4 mr-4 items-per-page-handler">
                    <div
                        ...
                        <span class="mr-2">{{ currentPage * itemsPerPage - (itemsPerPage - 1) }} - {{ vehicles.length - currentPage * itemsPerPage > 0 ? currentPage * itemsPerPage : vehicles.length }} {{ $t('of') }} {{ queriedItems }}</span>
    ...
    export default {
        ...
        methods: {
            ...
            async acceptDelete(tr) {
                await this.$store.dispatch("dataList/removeVehicle", tr.id).catch(err => {
                    console.error(err);
                    return 0;
                })
                this.$vs.notify({
                    ...
                    text: this.$t('Vehicle_Has_Been_Removed_Msg', [tr.name])
                })
            },
            editData(data) {
