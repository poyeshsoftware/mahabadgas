<template>
    <div id="data-list-list-view" class="data-list-container">
        ...
        <vs-table ref="table" pagination :max-items="itemsPerPage" search :noDataText="this.$t('No_Data_Text')"
            ...
            <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
                ...
                <div class="flex flex-wrap-reverse items-center data-list-btn-container">
                    ...
                    <div
                        ...
                        <span class="ml-2 text-base text-primary">{{ $t('Add_New_Category') }}</span>
                    </div>
                </div>
            ...
            <template slot="thead">
                <vs-th sort-key="name">{{$t('Category_Name')}}</vs-th>
    ...
    export default {
        ...
        methods: {
            ...
            async acceptDelete(tr) {
                await this.$store.dispatch("dataList/removeCategory", tr.id).catch(err => {
                    console.error(err);
                    return 0;
                })
                this.$vs.notify({
                    ...
                    text: this.$t('Category_Has_Been_Removed_Msg', [tr.name])
                })
            },
            editData(data) {
